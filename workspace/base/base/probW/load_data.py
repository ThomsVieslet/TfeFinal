...
def load_data(point = None):
  train_X = np.load("probW/datasets/custom/train_X.npy",allow_pickle=True)
  train_y = np.load("probW/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("probW/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("probW/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("probW/datasets/custom/names.npy",allow_pickle=True)
  nClasses = np.load("probW/datasets/original/Class.npy",allow_pickle=True)
