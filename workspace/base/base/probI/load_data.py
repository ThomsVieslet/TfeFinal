...
def load_data(point = None):
  ...
  train_y = np.load("probI/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("probI/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("probI/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("probI/datasets/custom/names.npy",allow_pickle=True)
  nClasses = np.load("probI/datasets/original/Class.npy",allow_pickle=True)
