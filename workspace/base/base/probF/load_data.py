...
def load_data(point = None):
  train_X = np.load("probF/datasets/custom/train_X.npy",allow_pickle=True)
  train_y = np.load("probF/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("probF/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("probF/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("probF/datasets/custom/names.npy",allow_pickle=True)
  nClasses = np.load("probF/datasets/original/Class.npy",allow_pickle=True)
