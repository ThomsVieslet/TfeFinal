...
if os.getcwd() == "/home/thoms/Desktop/stage/tfe_automl_vieslet/workspace/base/base/probR":
    from probR.load_data import load_data, load_test
else:
    ...
    if "model" in point.keys():
        if point["model"] == "randomForestClassifier":
            ...
            if test:
                ...
                filename = './probR/content/model_HPT'
