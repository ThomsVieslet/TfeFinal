...
if os.getcwd() == "/home/thoms/Desktop/stage/tfe_automl_vieslet/workspace/base/base/probM":
    from probM.load_data import load_data, load_test
else:
    ...
    if "model" in point.keys():
        if point["model"] == "randomForestClassifier":
            ...
            if test:
                ...
                filename = './probM/content/model_HPT'
