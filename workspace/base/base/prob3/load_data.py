...
def load_data(point = None):
  ...
  valid_X = np.load("prob3/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("prob3/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("prob3/datasets/custom/names.npy",allow_pickle=True)
