...
def load_data(point = None):
  train_X = np.load("prob4/datasets/custom/train_X.npy",allow_pickle=True)
  train_y = np.load("prob4/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("prob4/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("prob4/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("prob4/datasets/custom/names.npy",allow_pickle=True)
