...
def load_data(point = None):
  train_X = np.load("probX/datasets/custom/train_X.npy",allow_pickle=True)
  train_y = np.load("probX/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("probX/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("probX/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("probX/datasets/custom/names.npy",allow_pickle=True)
  nClasses = np.load("probX/datasets/original/Class.npy",allow_pickle=True)
