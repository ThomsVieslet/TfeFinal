...
if os.getcwd() == "/home/thoms/Desktop/stage/tfe_automl_vieslet/workspace/base/base/probS":
    from probS.load_data import load_data, load_test
else:
    ...
    if "model" in point.keys():
        if point["model"] == "randomForestClassifier":
            ...
            if test:
                ...
                filename = './probS/content/model_HPT'
