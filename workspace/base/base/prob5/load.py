...
def load():
    ...
    train_X = train.drop("y", axis='columns').to_numpy()
    ...
    valid_X = valid.drop("y", axis='columns').to_numpy()


    test_y = test.iloc[:,8].to_numpy()
    test_X = test.drop("y", axis='columns').to_numpy()

    np.save("prob5/datasets/original/train_X", train_X)
    np.save("prob5/datasets/original/train_y", train_y)
    np.save("prob5/datasets/original/valid_X", valid_X)
    np.save("prob5/datasets/original/valid_y", valid_y)
    np.save("prob5/datasets/original/test_X", test_X)
    np.save("prob5/datasets/original/test_y", test_y)

    features_names = np.delete(data.columns, [8])
    np.save("prob5/datasets/original/names", features_names)




    np.save("prob5/datasets/custom/train_X", train_X)
    np.save("prob5/datasets/custom/train_y", train_y)
    np.save("prob5/datasets/custom/valid_X", valid_X)
    np.save("prob5/datasets/custom/valid_y", valid_y)
    np.save("prob5/datasets/custom/test_X", test_X)
    np.save("prob5/datasets/custom/test_y", test_y)

    np.save("prob5/datasets/custom/names", features_names)
