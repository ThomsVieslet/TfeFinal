...
def load_data(point = None):
  ...
  train_y = np.load("prob2/datasets/custom/train_y.npy",allow_pickle=True)
  valid_X = np.load("prob2/datasets/custom/valid_X.npy",allow_pickle=True)
  valid_y = np.load("prob2/datasets/custom/valid_y.npy",allow_pickle=True)
  features_names = np.load("prob2/datasets/custom/names.npy",allow_pickle=True)
